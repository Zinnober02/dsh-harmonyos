...
function patchSandboxPolicy() {
  ...
  if (!txt.includes(anchor)) throw new Error('sandbox-policy 补丁锚点缺失');
...
function patchAll() {
  ...
  return { credential: r1, session: r2, permission: r3, attachment: r4, vision: r5, cordisLoader: r6, settingsCompat: r7, loopbackAuth: r8, fsLocal: r9, fsSearch: r10 };
}
